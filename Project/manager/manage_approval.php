    ...
    <div class="leaveAppFormContainer">
        ...
        <div id="leaveAppFooter">
            <div class="leaveAppFormButton">
                <input class="button-leaveApp" type="submit" value="Approve" formaction="approve_leave_application.php" 
                onclick="return(getApproveConfirmation());"><div></div>
                <input class="button-leaveApp" type="submit" value="Reject" formaction="reject_leave_application.php" 
                onclick="return(getRejectConfirmation());">
			</div>
            <div class="leaveAppFormButton">
