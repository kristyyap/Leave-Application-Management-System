...
<html>
<head>
    <title>Edit Leave Application Approval</title>
    ...
    <div class="leaveAppFormContainer">
        ...
        <div id="leaveAppFooter">
            <div class="leaveAppFormButton">
                <input class="button-leaveApp" type="submit" value="Approve" formaction="approve_leave_application.php" onclick="return(getApproveConfirmation());"><div></div>
